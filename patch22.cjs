...
const target = `<div className="bg-zinc-50 rounded-lg p-3 border border-zinc-200 text-center flex flex-col gap-1.5 shadow-sm mt-1">
        <p className="text-[11px] text-zinc-600 font-black flex items-center justify-center gap-1.5 uppercase tracking-wide">
          <Lock size={12} className="text-zinc-500" /> ACESSO RESTRITO
        </p>
        <p className="text-[10px] text-zinc-500 leading-relaxed whitespace-normal break-words">
